      ...
      { data: "is_active" },
      {
        mRender: function (data, type, row) {
          return (
            '<a href="' +
            path +
            "index.php?module=student&action=edit_student&id=" +
            row.id +
            '" class="table-edit" data-id="' +
            row.id +
            '" title="Edit Record"><i class="material-icons">&#xE254;</i></a><a href="javascript:void(0)" onclick="deleteStudent(' +
            row.id +
            ')" class="table-delete delete-' +
            row.id +
            '" data-id="' +
            row.id +
            '" title="Delete Record"><i class="material-icons">&#xE872;</i></a>'
          );
        },
      },
    ],
      ...
      { data: "is_active" },
      {
        mRender: function (data, type, row) {
          return (
            '<a href="' +
            path +
            "index.php?module=teacher&action=edit_teacher&id=" +
            row.id +
            '" class="table-edit" data-id="' +
            row.id +
            '" title="Edit Record"><i class="material-icons">&#xE254;</i></a><a href="javascript:void(0)" onclick="deleteTeacher(' +
            row.id +
            ')" class="table-delete delete-' +
            row.id +
            '" data-id="' +
      ...
      { data: "name" },
      {
        mRender: function (data, type, row) {
          return (
            '<a href="' +
            path +
            "index.php?module=subject&action=edit_subject&id=" +
            row.id +
            '" class="table-edit" data-id="' +
            row.id +
            '" title="Edit Record"><i class="material-icons">&#xE254;</i></a><a href="javascript:void(0)" onclick="deleteSubject(' +
            row.id +
            ')" class="table-delete delete-' +
            row.id +
            '" data-id="' +
      ...
      { data: "class_name" },
      {
        mRender: function (data, type, row) {
          return (
            '<a href="' +
            path +
            "index.php?module=section&action=edit_section&id=" +
            row.id +
            '" class="table-edit" data-id="' +
            row.id +
            '" title="Edit Record"><i class="material-icons">&#xE254;</i></a><a href="javascript:void(0)" onclick="deleteSection(' +
            row.id +
            ')" class="table-delete delete-' +
            row.id +
            '" data-id="' +
      ...
      { data: "name" },
      {
        mRender: function (data, type, row) {
          return (
            '<a href="' +
            path +
            "index.php?module=group&action=edit_class&id=" +
            row.id +
            '" class="table-edit" data-id="' +
            row.id +
            '" title="Edit Record"><i class="material-icons">&#xE254;</i></a><a href="javascript:void(0)" onclick="deleteClass(' +
            row.id +
            ')" class="table-delete delete-' +
            row.id +
            '" data-id="' +
